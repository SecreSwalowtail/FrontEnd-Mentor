...
function Info(props) {
    ...
    const pinColor = props.theme === 'white' ? '../src/assets/pin-white.svg' : '../src/assets/pin.svg'
    const urlColor = props.theme === 'white' ? '../src/assets/url-white.svg' : '../src/assets/url.svg'
    const twitterColor = props.theme === 'white' ? '../src/assets/twitter-white.svg' : '../src/assets/twitter.svg'
    const officeColor = props.theme === 'white' ? '../src/assets/building-white.svg' : '../src/assets/building.svg'
